 ...
 * order of the difference (weight - length). => This is a WRONG greedy algorithm
 * 
 * Input format:
 ...
 * 
 * Break ties: 
 * If two jobs have equal difference (weight - length), the job with higher weight should be scheduled first. 
 * 
 * Output format:
...
public class DifferenceSchedule {
